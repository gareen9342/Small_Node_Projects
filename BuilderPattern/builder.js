/**
 * ㅂㅣㄹ더 패턴은 복잡한 객체의 생성을 단순화하는 생성 디자인 패턴
 *
 *
 * -> 인자의 목록이 길거나, 많ㅇ느 복잡한 매개 변수를 입력으로 사용한느 생성자가 있는 클래스의 단접을 극복가능
 *
 * 인자가 많은 생성자를 가지고 있는 클래스가 있을 때에 생성자
 * -> 객체리터럴로 모든 인수를 모아 넣ㄴ느 방법으로 개선
 * -> 하지만 이렇게 만들경우도 클래스를 열어봐야  하는 단점이 있음ㄴ
 *
 * 빌더 패턴은 이런 단점을 보왆난다.
 *
 *
